                            ...
                            <table class="table table-striped table-responsive-md">
                                ...
                                <tbody>
                                    <tr th:each="user : ${users}">
                                        ...
                                        <td><a th:href="@{/user/{id}(id=${user.id})}" class="btn btn-primary"><i
                                                    class="fas fa-marker ml-2"></i></a></td>
                                        <td><a th:href="@{/user/update/{id}(id=${user.id})}" class="btn btn-primary"><i
                                                    class="fas fa-user-edit ml-2"></i></a></td>
                                        <td><a th:href="@{/remove-user/{id}(id=${user.id})}" class="btn btn-primary"><i
